...
public class ForceModuleTypeDA extends DVLClient{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		while (errorFound == false){
			...
			getAllRefDataRequest.setRefTable(JopesRefTablesTypes.FORCE_MODULE_TYPE_REF);
			...
			try{
				...
				if ( (getAllRefDataResponse == null) || (getAllRefDataResponse.getForceModuleTypeRef() == null) ){
					break;  //stop requesting data
				}
				
				System.out.println("Got data back from service.");

				List<ForceModuleTypeRef> ccRefs = getAllRefDataResponse.getForceModuleTypeRef();
		...
		if (errorMsg != null){
		  ...
		  out.println("<h1>" + "Saved " + numReceived + " ForceModuleTypeRef objects." + "</h1>");
		}
