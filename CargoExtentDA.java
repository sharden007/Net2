...
public class CargoExtentDA extends DVLClient{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		while (errorFound == false){
			...
			getAllRefDataRequest.setRefTable(JopesRefTablesTypes.CARGO_EXTENT_REF);
			...
			try{
				...
				if ( (getAllRefDataResponse == null) || (getAllRefDataResponse.getCargoExtentRef() == null) ){
					break;  //stop requesting data
				}
				
				System.out.println("Got data back from service.");

				List<CargoExtentRef> ccRefs = getAllRefDataResponse.getCargoExtentRef();
		...
		if (errorMsg != null){
		  ...
		  out.println("<h1>" + "Saved " + numReceived + " CargoExtRef objects." + "</h1>");
		}
