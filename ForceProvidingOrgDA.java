...
public class ForceProvidingOrgDA extends DVLClient{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		while (errorFound == false){
			...
			getAllRefDataRequest.setRefTable(JopesRefTablesTypes.FORCE_PROVIDING_ORG_REF);
			...
			try{
				...
				if ( (getAllRefDataResponse == null) || (getAllRefDataResponse.getForceProvidingOrgRef() == null) ){
					break;  //stop requesting data
				}
				
				System.out.println("Got data back from service.");

				List<ForceProvidingOrgRef> ccRefs = getAllRefDataResponse.getForceProvidingOrgRef();
		...
		if (errorMsg != null){
		  ...
		  out.println("<h1>" + "Saved " + numReceived + " ForceProvidingOrgRef objects." + "</h1>");
		}
