...
public class CargoCatDA extends DVLClient{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		while (errorFound == false){
			...
			getAllRefDataRequest.setRefTable(JopesRefTablesTypes.CARGO_CAT_REF);
			...
			try{
				...
				if ( (getAllRefDataResponse == null) || (getAllRefDataResponse.getCargoCatRef() == null) ){
					break;  //stop requesting data
				}
				
				System.out.println("Got data back from service.");

				List<CargoCatRef> ccRefs = getAllRefDataResponse.getCargoCatRef();
		...
		if (errorMsg != null){
		  ...
		  out.println("<h1>" + "Saved " + numReceived + " CargoCatRef objects." + "</h1>");
		}
