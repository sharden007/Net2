...
public class SourceDA extends DVLClient{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		while (errorFound == false){
			...
			getAllRefDataRequest.setRefTable(JopesRefTablesTypes.SOURCE_REF);
			...
			try{
				...
				if ( (getAllRefDataResponse == null) || (getAllRefDataResponse.getSourceRef() == null) ){
					break;  //stop requesting data
				}
				
				System.out.println("Got data back from service.");

				List<SourceRef> ccRefs = getAllRefDataResponse.getSourceRef();
		...
		if (errorMsg != null){
		  ...
		  out.println("<h1>" + "Saved " + numReceived + " SourceRef objects." + "</h1>");
		}
