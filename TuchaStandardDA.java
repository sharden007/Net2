...
public class TuchaStandardDA extends DVLClient{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		while (errorFound == false){
			...
			getAllRefDataRequest.setRefTable(JopesRefTablesTypes.TUCHA_STANDARD_REF);
			...
			try{
				...
				if ( (getAllRefDataResponse == null) || (getAllRefDataResponse.getTuchaStandardRef() == null) ){
					break;  //stop requesting data
				}
				
				System.out.println("Got data back from service.");

				List<TuchaStandardRef> ccRefs = getAllRefDataResponse.getTuchaStandardRef();
		...
		if (errorMsg != null){
		  ...
		  out.println("<h1>" + "Saved " + numReceived + " TuchaStandardRef objects." + "</h1>");
		}
